...
if __name__ == '__main__':
    ...
    parser.add_argument('--bucket_id', type=int, help='bucket id of the saved bucket')
    ...
    np.array(buckets[args.bucket_id], dtype=np.uint32).tofile(args.save_dir + '/' + args.dataset + args.result_suffix + '_bucket_' + str(args.bucket_id))
